...
# 질문과 답변 게시판
# Question - pk(자동생성),제목(subject), 내용(content), 작성일(created_at),수정일(modified_at,null =True,blank=True)
# Answer - pk(자동생성),질문(외래키), 내용, 작성일,수정일
...
# 질문에 대한 댓글 : author,content,create_at,modified_at,question
# 답변에 대한 댓글 : author,content,create_at,modified_at,answer
