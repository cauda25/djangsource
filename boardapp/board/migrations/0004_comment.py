    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modityed_at', models.DateTimeField(blank=True, null=True, verbose_name='수정일시')),
                ('answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='board.answer', verbose_name='답변변')),
